package com.relativity.springstarter.starter.dtos;
 ...
 * @author avakhobov
 */
public abstract class AbstractGenericDto implements Serializable, Comparable<AbstractGenericDto> {

    /**
     * Default {@link AbstractGenericDto} comparator.
     */
    public static final Comparator<AbstractGenericDto> DEFAULT_DTO_COMPARATOR = new AbstractGenericDtoComparator();
