package com.relativity.springstarter.starter.dtos.user;

import com.relativity.springstarter.starter.dtos.AbstractGenericDto;
import com.relativity.springstarter.starter.dtos.AbstractGenericDtoComparator;
...
public class UserDto extends AbstractGenericDto {
     ...
     * Default {@link UserDto} comparator.
     */
    public static final Comparator<AbstractGenericDto> DEFAULT_USER_DTO_COMPARATOR = new UserDtoComparator();
