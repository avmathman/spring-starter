 ...
 * @author avakhobov
 */
public abstract class AbstractGenericBridge<T extends AbstractGenericEntity, D extends AbstractGenericDto> {
    ...
    public T toEntity(final D dto) {
        ...
        if (dto.getCreatedBy() != null) {
            ...
            if (userRepository == null) {
                createdBy = new User();
                createdBy.setId(dto.getModifiedBy());
            } else {
        ...
        if (dto.getModifiedBy() != null) {
            ...
            if (userRepository == null) {
                modifiedBy = new User();
                modifiedBy.setId(dto.getModifiedBy());
            } else {
