package com.relativity.springstarter.starter.services;
 ...
 * @author avakhobov
 */
public abstract class AbstractGenericService<T extends AbstractGenericEntity, D extends AbstractGenericDto> implements GenericService<T, D> {
    ...
    protected AbstractGenericService(
            ...
            final AbstractGenericBridge<T, D> bridge
    ) {
        super();
    ...
    @Override
    public Optional<T> findById(UUID entityId) {
    ...
    public void deleteById(UUID entityId) {
        ...
        final Integer deleted = repository.deleteByUserId(entityId);
